...
输出文件：`{输出目录}/ddd-01-bounded-context-outline.md`
...
限界上下文设计大纲已生成
==================================================
文件：{输出目录}/ddd-01-bounded-context-outline.md
...
```
读取：{输出目录}/ddd-01-bounded-context-outline.md
...
输出：`{输出目录}/ddd-01-bounded-context.md`
...
**输入**：PRD 文档路径
**输出**：
1. `ddd-01-bounded-context-outline.md`（大纲）
2. `ddd-01-bounded-context.md`（详细）
...
**方法**：
1. 基于设计指南生成（bounded-context-guide.md）
2. 大纲阶段人工评审
3. 详细版包含质量检查清单
